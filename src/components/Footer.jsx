    ...
    <footer style={{ background: '#0A2540', color: 'rgba(255,255,255,0.8)', paddingTop: 64 }}>
      <div className="container">
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: 48, paddingBottom: 48 }}>
          {/* Brand */}
          <div>
            <img src={asset('logo.png')} alt="Overdime Technologies" style={{ height: 44, marginBottom: 16 }} />
            ...
            <div style={{ display: 'flex', gap: 12, marginTop: 20 }}>
              <a href="https://www.linkedin.com/company/overdime-technologies/" target="_blank" rel="noreferrer" aria-label="LinkedIn" style={iconStyle}><Linkedin size={18} /></a>
