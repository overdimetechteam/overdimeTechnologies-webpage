    ...
    <div>
      ...
      <div className="page-hero">
        <div className="container">
          <span style={{ display: 'inline-block', background: 'rgba(0,176,237,0.2)', color: '#00B0ED', fontSize: 13, fontWeight: 600, letterSpacing: '0.08em', textTransform: 'uppercase', padding: '6px 14px', borderRadius: 100, marginBottom: 20 }}>Contact</span>
      ...
      <section className="section" style={{ background: '#FAF7F2' }} id="form">
        <div className="container">
          <div className="grid-2" style={{ gap: 64, alignItems: 'flex-start' }}>
            {/* Form */}
            <div style={{ background: '#fff', borderRadius: 20, padding: '48px 40px', boxShadow: '0 4px 24px rgba(10,37,64,0.08)' }}>
              ...
              <form onSubmit={handleSubmit} noValidate>
                ...
                <div className="grid-2" style={{ gap: 16 }}>
                  ...
                  <div>
                    {field('phone', 'Phone Number', 'tel', '+94 xxx xxx xxx')}
                  </div>
                </div>
            ...
            <div>
              ...
              {/* Map placeholder */}
              <div style={{ marginTop: 32, borderRadius: 16, overflow: 'hidden', height: 220, background: '#E5E7EB', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#9CA3AF', fontSize: 14 }}>
