              ...
              {filtered.map((cs, i) => (
                <FadeUp key={cs.client} delay={i * 0.1}>
                  <div className="case-card-grid">
                    ...
                    {/* Right: metric */}
                    <div className="case-metric-panel" style={{ background: 'linear-gradient(135deg, #0A2540, #0d3460)', padding: '48px 40px', display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', textAlign: 'center' }}>
