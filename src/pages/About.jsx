          ...
          <div className="container">
            <div className="grid-2" style={{ gap: 64, alignItems: 'center' }}>
              <SlideLeft>
                ...
                <h2 style={{ fontSize: 'clamp(18px, 2.5vw, 24px)', marginBottom: 24 }}>Built on a Simple Belief: Technology Should Make Business Simpler</h2>
        ...
        <section style={{ background: 'linear-gradient(135deg, #0A2540 0%, #0d3460 100%)', padding: '80px 0' }}>
          <div className="container" style={{ textAlign: 'center' }}>
            <FadeUp>
              ...
              <h2 style={{ color: '#fff', fontSize: 'clamp(18px, 2.5vw, 24px)', maxWidth: 760, margin: '0 auto 24px', lineHeight: 1.3 }}>
          ...
          <div className="container">
            <FadeUp>
              <div style={{ textAlign: 'center', marginBottom: 56 }}>
                ...
                <h2 style={{ fontSize: 'clamp(18px, 2.5vw, 24px)', marginTop: 8 }}>The Principles That Guide Everything We Do</h2>
              </div>
            </FadeUp>
          ...
          <div className="container">
            <FadeUp>
              <div style={{ textAlign: 'center', marginBottom: 56 }}>
                ...
                <h2 style={{ fontSize: 'clamp(18px, 2.5vw, 24px)', marginTop: 8 }}>The People Behind the Solutions</h2>
              </div>
            </FadeUp>
            <div className="grid-3">
              {[
                { name: 'Suresh de Silva', role: 'Founder & CEO', bio: 'With over 25 years of experience in technology, telecommunications, infrastructure, and client-facing leadership roles, Suresh brings deep strategic insight and a practical understanding of complex business environments.', initial: 'S' },
                { name: 'Senior Consultant', role: 'Digital Transformation Lead', bio: 'Bringing deep expertise in business process improvement and change management, our senior consultants guide organisations through transformative digital journeys with practical, results-focused strategies.', initial: 'C' },
                { name: 'Technology Team', role: 'Engineering & AI', bio: 'Our engineering team combines expertise across automation platforms, AI development, and custom software to deliver solutions that are both technically excellent and genuinely useful.', initial: 'T' },
              ].map((member, i) => (
          ...
          <div className="container">
            <div className="grid-2" style={{ gap: 64, alignItems: 'center' }}>
              <SlideLeft>
                ...
                <h2 style={{ fontSize: 'clamp(18px, 2.5vw, 24px)', marginBottom: 32 }}>A Partner Who Truly Understands Your Business</h2>
              ...
              <SlideRight>
                <div style={{ background: 'linear-gradient(135deg, #0A2540, #0d3460)', borderRadius: 24, padding: 48, color: '#fff' }}>
                  <div style={{ fontSize: 'clamp(32px, 5vw, 48px)', fontWeight: 800, color: '#F4C95D', fontFamily: 'Plus Jakarta Sans', marginBottom: 8 }}>25+</div>
                  <div style={{ color: 'rgba(255,255,255,0.85)', fontSize: 15, marginBottom: 28 }}>Years of combined leadership experience in global enterprises</div>
                  <div style={{ fontSize: 'clamp(32px, 5vw, 48px)', fontWeight: 800, color: '#00B0ED', fontFamily: 'Plus Jakarta Sans', marginBottom: 8 }}>3+</div>
                  <div style={{ color: 'rgba(255,255,255,0.85)', fontSize: 15, marginBottom: 28 }}>Enterprise organisations served, including publicly listed companies</div>
                  <div style={{ fontSize: 'clamp(32px, 5vw, 48px)', fontWeight: 800, color: '#F4C95D', fontFamily: 'Plus Jakarta Sans', marginBottom: 8 }}>100%</div>
